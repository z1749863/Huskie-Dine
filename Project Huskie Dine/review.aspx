...
&nbsp;&nbsp;&nbsp;
    ...
    &nbsp;&nbsp;&nbsp;
        <span style="border:1px solid black;border-radius:5px;background-color:white;padding:10px"><asp:HyperLink ID="HyperLink6" runat="server" ForeColor="white" style="text-align: justify;text-decoration:none;color:black" NavigateUrl="~/Project/login.aspx" CssClass="auto-style4">Login</asp:HyperLink>
        <br />
        </span>
